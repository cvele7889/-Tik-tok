              ...
              <div className="p-1">
                ...
                >
                  <div className="flex items-center">
                    ...
                    />
                    <div className="truncate ml-2">MC dev</div>
                  </div>
                </Link>
              </div>
            </div>
            ...
            {true ? (
              ...
              <div className="flex items-center">
                <div className="relative">
                  ...
                  <div className="absolute bg-white  rounded-lg  py-1.5 w-[200px] shalow-xl border top-[40px] right-0">
                    <button className="flex items-center w-full  justify-start py-3 px-3 hover:bg-gray-100 cursor-pointer">
                      <BiUser size="20" />
